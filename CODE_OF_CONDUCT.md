...
This is a tool that gets pointed at real business applications, most of them built for clients under
contract. Two things follow from that:

**Don't paste proprietary code into this repository.** Bug reports need the XAF *pattern*, never your
employer's or your client's domain. Rename the entities, strip the business rules to their shape, and
the report is just as useful — see [CONTRIBUTING.md](CONTRIBUTING.md).

**Assume the person on the other end inherited their codebase.** A lot of XAF applications are ten
years old and were written under deadlines by people who are no longer there. When someone shows you
a pattern the extractor missed, they are showing you code they often did not choose. Review the
pattern, not the programmer.
