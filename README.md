...
**v0.17.1.** The extraction engine is the mature part: it runs in production against real XAF
...
| ✅ | **619 tests** over synthetic XPO and EF Core fixtures — no DevExpress needed |
