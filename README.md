...
**v0.17.2.** The extraction engine is the mature part: it runs in production against real XAF
...
| ✅ | **654 tests** over synthetic XPO and EF Core fixtures — no DevExpress needed |
